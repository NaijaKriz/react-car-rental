...
const skillsData = [
        {
            ...
            link: "#",
            description: "Experience a booking process thats as swift as the windour user friendly platform ensures you find the perect vehicle for your journey with ust a few clicks. Our diverse fleet boasts a range of vehiclesto suit every adventure.",
            aosDelay: "0"
        },
        {
            name: "Fast and Safe",
        ...
        <div className="container">
            ...
            md:grid-cols-3 gap-4">
                {skillsData.map((skill) =>(
                    ...
                    sm:space-y-6 p-4 sm:py-16 bg-dark hover:bg-primary
